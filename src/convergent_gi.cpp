...
ConvergentGlobalIllumination::ConvergentGlobalIllumination(
    shared_ptr<Scene> scene, int sampleCount, int width, int height)
    : LightingEngine(scene->triangles, scene->light),
      gi(new GlobalIllumination(scene, sampleCount)),
