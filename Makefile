...
# Compilation options
CXXFLAGS = -std=c++11 -Wall -march=native -fopenmp -ggdb -g3 -D unix -D GLM_FORCE_SSE2 -D GLM_FORCE_ALIGNED -D textureLess $(addprefix -I, $(HDIR)) $(shell sdl-config --cflags) $(DEPFLAGS)
