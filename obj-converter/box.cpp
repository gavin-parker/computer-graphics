...
Box::Box(){
AddMaterial(string("green"), vec3(0.15, 0.75, 0.15), vec3(0.15, 0.75, 0.15), vec3(0.15, 0.75, 0.15), 500, string("marble.png"), string("marble.png"), string(""), string(""), false);
AddMaterial(string("red"), vec3(0.75, 0.15, 0.15), vec3(0.75, 0.15, 0.15), vec3(0.75, 0.15, 0.15), 500, string("marble.png"), string("marble.png"), string(""), string(""), false);
AddMaterial(string("short"), vec3(0.75, 0.75, 0.75), vec3(0.75, 0.75, 0.75), vec3(0.75, 0.75, 0.75), 500, string("red.png"), string("red.png"), string(""), string(""), false);
AddMaterial(string("tall"), vec3(0.75, 0.75, 0.75), vec3(0.75, 0.75, 0.75), vec3(0.75, 0.75, 0.75), 500, string("green.png"), string("green.png"), string(""), string(""), false);
AddMaterial(string("white"), vec3(0.75, 0.75, 0.75), vec3(0.75, 0.75, 0.75), vec3(0.75, 0.75, 0.75), 500, string("marble.png"), string("marble.png"), string(""), string(""), false);
