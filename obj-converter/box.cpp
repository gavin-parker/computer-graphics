...
Box::Box(){
AddMaterial(string("green"), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 0.0), 0, string(""), string(""), string(""), string(""));
AddMaterial(string("red"), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 0.0), 0, string(""), string(""), string(""), string(""));
AddMaterial(string("short"), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 0.0), 0, string(""), string(""), string(""), string(""));
AddMaterial(string("tall"), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 0.0), 0, string(""), string(""), string(""), string(""));
AddMaterial(string("white"), vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, 1.0), vec3(0.0, 0.0, 0.0), 0, string(""), string(""), string(""), string(""));
