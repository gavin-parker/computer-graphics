...
// given a line and a new 2d point, finds the new corresponding 3d point on the
// line
inline vec4 pointOnLine(Line line, vec2 newPoint) {
  ...
  return vec4(newPoint.x, newPoint.y, lerpF(line.a.z, line.b.z, t),
              lerpF(line.a.w, line.b.w, t));
}
